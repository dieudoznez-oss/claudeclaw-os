    ...
    <div class="flex items-center gap-2">
      ...
      <div class="model-picker" onclick="toggleModelPicker(this)" style="display:inline-block">
        ...
        <div class="model-menu" style="display:none;right:0;left:auto">
          <div class="model-opt" data-model="claude-opus-4-8" onclick="pickGlobalModel(this)">All Opus</div>
...
async function loadAgents() {
  try {
    ...
    container.innerHTML = data.agents.map(a => {
      ...
      const modelOpts = ['claude-opus-4-8', 'claude-sonnet-4-6', 'claude-sonnet-4-5', 'claude-haiku-4-5'];
      const modelShort = function(m) { return {'claude-opus-4-8':'Opus','claude-sonnet-4-6':'Sonnet','claude-sonnet-4-5':'Sonnet 4.5','claude-haiku-4-5':'Haiku'}[m] || m; };
